...
return view.extend({
	...
	render: function (data) {
		...
		o = s.taboption('provider', form.ListValue, 'data_provider', _('Provider'),
			_('bolt: pure Go embedded DB, no extra build dependency (default). sqlite: requires a build with CGO/sqlite support. memory: nothing is persisted, for testing only.'));
		o.value('bolt', _('bolt (embedded, recommended)'));
