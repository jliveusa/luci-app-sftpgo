	...
	render: function (data) {
		...
		return this.checkRunning().then(function (checkResult) {
			...
			if (!isRunning || !enabled) {
				var message = !enabled
					? _('SFTPGo is disabled. Enable it on the Basic Setting page.')
				...
				children.push(E('p', { style: 'opacity:0.8;' },
				...
				if (summary.legacy_uci_ignored) {
					children.push(E('div', { class: 'alert-message warning' },
						_('Old UCI protocol/database keys are present but ignored; they do not affect the running service.')));
				}
